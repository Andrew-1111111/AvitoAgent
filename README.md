...
Файл `.github/workflows/build.yml` на каждый push и pull request собирает оба варианта под `win-x64` и публикует артефакты:
...
- **GitHub Actions** — сборка win-x64 с зависимостью от .NET и автономная
